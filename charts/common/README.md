# Open Charts Common Library Chart

A [Helm Library Chart](https://helm.sh/docs/topics/library_charts/#helm) for grouping common logic between Open Charts.
...
dependencies:
  - name: common
    version: 2.x.x
    repository: oci://registry-1.docker.io/opencharts
```
...
Looking to use our applications in production? Try [Open Charts](https://github.com/open-charts/charts), the community-maintained charts.

## Open Charts Community Project

This chart is part of the Open Charts community project, which provides freely available Helm charts for popular applications. Our charts are community-maintained and focus on providing stable, secure, and well-documented deployments for Kubernetes.
